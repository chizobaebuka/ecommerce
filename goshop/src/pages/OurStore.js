                            ...
                            <div className='filter-card mb-3'>
                                ...
                                <div>
                                    <div className="random-products d-flex  mb-3">
                                        ...
                                        <div className="w-50">
                                            <h5>Immerse in sound with sleek headphones </h5>
                                            <ReactStars
                                                count={5}
                                                size={24}
                                                value={4}
                                    ...
                                    <div className="random-products d-flex ">
                                        <div className="w-50">
                                            <img src="images/watch_5.jpg" className="img-fluid" alt="headphone" />
                                        </div>
                                        <div className="w-50">
                                            <h5>Immerse in sound with sleek headphones </h5>
                                            <ReactStars
                                ...
                                <div className="d-flex justify-content-between align-items-center gap-10">
                                    <div className="d-flex align-items-center gap-10">
                                        ...
                                        <select name="" className='form-control form-select' id="">
                                            ...
                                            <option value="price ascending">Alphabetically, low-high</option>
                                            <option value="price descending">Alphabetically, high-low</option>
